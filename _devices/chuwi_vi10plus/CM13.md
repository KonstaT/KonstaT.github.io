...
*A: Older Hi10 Plus devices don't need any compatibility patch. Devices shipped with 20170220, 20170315, 20170504 and 20171020 firmware also work apart from the camera because of hardware changes and lack of kernel source code.*

Q: I have Hi10 Pro. What should I do?  
*A: Download patch below and install it in TWRP. Hi10 Pro (z8350 - serial no HQ64) is not supported because of hardware changes (touchscreen, camera) and lack of kernel source code.*
