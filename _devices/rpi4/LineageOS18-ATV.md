...
Here's my build of LineageOS 18.1 Android TV for Raspberry Pi 4 Model B and Pi 400. It is unofficial and unsupported by the LineageOS team. It's for **advanced users** only. Pi 4 model with at least 2GB of RAM is required to run this build.
...
1. Download [lineage-18.1-rpi-magisk-v24.3.zip](https://www.androidfilehost.com/?fid=2981970449027577730) and save it to your device's internal storage or use an external USB drive
