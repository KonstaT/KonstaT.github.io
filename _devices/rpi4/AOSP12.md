...
1. Download [AOSP12-rpi-magisk-v25.2.zip](https://www.androidfilehost.com/?fid=14871746926876826808) and save it to your device's internal storage or use an external USB drive
2. Download [Magisk-v25.2.apk](https://github.com/topjohnwu/Magisk/releases/tag/v25.2)
3. Boot to TWRP recovery (see FAQ)
4. Install AOSP12-rpi-magisk-v25.2.zip from your selected storage
5. Boot out of recovery (see FAQ)
